...
public class ExcelStepDefinitions {
    ...
    public void user_tries_to_login_as(String sheet) throws IOException {
            ...
            String path ="./src/test/resources/testdata/mysmoketestdata.xlsx";// ./ means all of the previous folders
            String sheetName=sheet;
            excelUtil=new ExcelUtil(path,sheetName);
//      getDataList() method returns all excel data        /// src/test/resources/testdata/mysmoketestdata.xlsx
